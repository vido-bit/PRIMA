...
declare namespace FudgeUserInterface {
  ...
  class Controller {
    ...
    private idInterval;
    constructor(
      _mutable: ƒ.Mutable | ƒ.MutableArray<ƒ.Mutable>,
...
declare namespace FudgeUserInterface {
  ...
  class Generator {
     ...
     */
    static createDetailsFromMutable(
      _mutable: ƒ.Mutable | ƒ.MutableArray<ƒ.Mutable>,
      _name?: string,
      _mutator?: ƒ.Mutator
     ...
     */
    static createInterfaceFromMutable(
      _mutable: ƒ.Mutable | ƒ.MutableArray<ƒ.Mutable>,
      _mutator?: ƒ.Mutator
    ): HTMLDivElement;
    /**
     ...
     */
    static createInterfaceFromMutator(
      _mutator: ƒ.Mutator | Object
    ): HTMLDivElement;
    /**
     * Create a specific CustomElement for the given data, using _key as identification
     */
    static createMutatorElement(
      _key: string,
      _type: Object | string,
      _value: Object
    ): HTMLElement;
...
declare namespace FudgeUserInterface {
  ...
  class Dialog {
     ...
     */
    static prompt(
      _data: ƒ.Mutable | ƒ.Mutator | Object,
      _modal?: boolean,
      _head?: string,
